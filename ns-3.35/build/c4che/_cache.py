...
CC = ['/usr/bin/clang']
CCDEFINES = ['_DEBUG']
CCFLAGS = ['-O0', '-ggdb', '-g3', '-Wall', '-Werror', '-std=c++17', '-Wno-unused-local-typedefs', '-Wno-potentially-evaluated-expression']
CCLNK_SRC_F = []
CCLNK_TGT_F = ['-o']
CC_NAME = 'clang'
CC_SRC_F = []
...
CFLAGS_PYEMBED = ['-g', '-fwrapv', '-O3']
CFLAGS_PYEXT = ['-g', '-fwrapv', '-O3']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'clang'
COMPILER_CXX = 'clang++'
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/clang++']
CXXFLAGS = ['-std=c++17', '-Wno-unused-local-typedefs', '-Wno-potentially-evaluated-expression']
CXXFLAGS_MACBUNDLE = ['-fPIC']
CXXFLAGS_PYEMBED = ['-g', '-fwrapv', '-O3']
CXXFLAGS_PYEXT = ['-g', '-fwrapv', '-O3', '-Wno-array-bounds']
...
DEFINES = ['NS3_BUILD_PROFILE_DEBUG', 'NS3_ASSERT_ENABLE', 'NS3_LOG_ENABLE', 'HAVE_SYS_IOCTL_H=1', 'HAVE_IF_NETS_H=1', 'HAVE_NET_ETHERNET_H=1', 'HAVE_SQLITE3=1', 'HAVE_SEMAPHORE_H=1', 'HAVE_GSL=1', 'HAVE_GCRYPT=1']
DEFINES_PYEMBED = ['NDEBUG', 'OPENSSL_NO_SSL3']
DEFINES_PYEXT = ['NDEBUG', 'OPENSSL_NO_SSL3']
DEFINES_ST = '-D%s'
...
ENABLE_GSL = '-I/opt/homebrew/Cellar/gsl/2.8/include -L/opt/homebrew/Cellar/gsl/2.8/lib -lgsl -lgslcblas -lm\n'
ENABLE_GTK = None
...
INCLUDES_GCRYPT = ['/opt/homebrew/opt/libgcrypt/include', '/opt/homebrew/opt/libgpg-error/include']
INCLUDES_GSL = ['/opt/homebrew/Cellar/gsl/2.8/include']
INCLUDES_PYEMBED = ['/Users/kamikawamasahiro/.pyenv/versions/3.9.13/include/python3.9', '/opt/homebrew/opt/zlib']
INCLUDES_PYEXT = ['/Users/kamikawamasahiro/.pyenv/versions/3.9.13/include/python3.9', '/opt/homebrew/opt/zlib']
INFODIR = '/usr/local/share/info'
INT64X64_USE_128 = 1
LIBDIR = '/usr/local/lib'
LIBEXECDIR = '/usr/local/libexec'
LIBGCRYPT_CONFIG = ['/opt/homebrew/bin/libgcrypt-config']
LIBPATH_GCRYPT = ['/opt/homebrew/opt/libgcrypt/lib', '/opt/homebrew/opt/libgpg-error/lib']
LIBPATH_GSL = ['/opt/homebrew/Cellar/gsl/2.8/lib']
LIBPATH_PYEMBED = ['/Users/kamikawamasahiro/.pyenv/versions/3.9.13/lib', '/opt/homebrew/lib']
LIBPATH_PYEXT = ['/Users/kamikawamasahiro/.pyenv/versions/3.9.13/lib', '/opt/homebrew/lib']
LIBPATH_ST = '-L%s'
LIB_BOOST = []
LIB_GCRYPT = ['gcrypt', 'gpg-error']
LIB_GSL = ['gsl', 'gslcblas', 'm']
LIB_LIBXML2 = ['xml2']
LIB_PYEMBED = ['python3.9', 'intl', 'dl', 'python3.9', 'intl', 'dl']
LIB_PYEXT = ['intl', 'dl', 'intl', 'dl']
LIB_SQLITE3 = ['sqlite3']
LIB_ST = '-l%s'
...
NS3_EXECUTABLE_PATH = ['/Users/kamikawamasahiro/Downloads/ns-allinone-3.35/ns-3.35/build/src/fd-net-device']
...
PYO = 1
PYTAG = 'cpython-39'
PYTHON = ['/Users/kamikawamasahiro/.pyenv/versions/3.9.13/bin/python3']
...
PYTHON_CONFIG = ['/Users/kamikawamasahiro/.pyenv/versions/3.9.13/bin/python3-config']
PYTHON_VERSION = '3.9'
REQUIRED_BOOST_LIBS = []
RPATH_PYEMBED = ['/Users/kamikawamasahiro/.pyenv/versions/3.9.13/lib', '/opt/homebrew/lib', '/Users/kamikawamasahiro/.pyenv/versions/3.9.13/lib', '/opt/homebrew/lib']
RPATH_PYEXT = ['/Users/kamikawamasahiro/.pyenv/versions/3.9.13/lib', '/opt/homebrew/lib', '/Users/kamikawamasahiro/.pyenv/versions/3.9.13/lib', '/opt/homebrew/lib']
RPATH_ST = '-Wl,-rpath,%s'
...
VERSION = '3.35'
WITH_PYBINDGEN = '/Users/kamikawamasahiro/Downloads/ns-allinone-3.35/pybindgen-0.22.0'
cfg_files = ['/Users/kamikawamasahiro/Downloads/ns-allinone-3.35/ns-3.35/build/ns3/config-store-config.h', '/Users/kamikawamasahiro/Downloads/ns-allinone-3.35/ns-3.35/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
